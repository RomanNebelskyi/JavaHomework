...
public class Main {
    public static void main(String[] args) {
        ...
        globalUsers.put(new Person("Jason", 12), null);
        globalUsers.put(new Person("Bil", 12), new LinkedList<>(Arrays.asList(new Account[]{new Account("example@gmail.com", "fghjk"), new Account("Bogas234", "ghjk")})));
    ...
    static void delAccountForPerson(Map<Person, List<Account>> map)
    {
        ...
        while (myIter.hasNext()) {                  //iterator to find the person in our Map
            ...
            if (name.equalsIgnoreCase(person.getName())) { // actions if found
                ...
                {
                    case 1:
                        map.put(person, null); //deleting all accs
                        return;
                    default:
